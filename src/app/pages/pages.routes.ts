...
export const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                path: 'contact',
                loadComponent: () =>
                    import('./contact-us-form/contact-us-form.component').then(
                        (c) => c.ContactUsFormComponent
                    ),
            ...
            },
            {
                ...
                loadComponent: () =>
                    import(
                        './user-profile-manager/user-profile-manager.component'
                    ).then((c) => c.UserProfileManagerComponent),
